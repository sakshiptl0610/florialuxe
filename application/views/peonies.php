...
<div>
  <div class="top-header body-content">
    <div class="main-container d-flex justify-content-between align-items-center">
      <h2 class="page-title font-canegroni">Peonies</h2>
      <div class="breadcrumb font-nexalight  ">Home /peonies</div>
    </div>
  </div>
  ...
  <div class="main-container">
    <div class="inner-p-container">
      <div class="view-cart-box">
        <div>
          “peonies” has been added to your cart.
        </div>
      ...
      <div class="product-row">
        ...
        <div class="product-row-inner">
          <div class="p-product-image">
            <img id="mainProductImage" src="<?= base_url() ?>assets/Images/FLORIA-9.jpg"
          ...
          <div class=" product-content-box">
            ...
            <p class="font-canegroni text-color title">Peonies</p>
