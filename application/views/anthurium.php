...
<div>
  <div class="top-header body-content">
    <div class="main-container d-flex justify-content-between align-items-center">
      <h2 class="page-title font-canegroni">Anthurium</h2>
      <div class="breadcrumb font-nexalight  ">Home /anthurium</div>
    </div>
  </div>
  ...
  <div class="main-container">
    <div class="inner-p-container">
      <div class="view-cart-box">
        <div>
          “anthurium” has been added to your cart.
        </div>
      ...
      <div class="product-row">
        ...
        <div class="product-row-inner">
          <div class="p-product-image">
            <img id="mainProductImage" src="<?= base_url() ?>assets/Images/FLORIA-10.jpg"
          ...
          <div class=" product-content-box">
            ...
            <p class="font-canegroni text-color title">Anthurium</p>
            ...
            <p class="text-color font-nexalight tagline mt-3 ">
              Our anthuriums are celebrated for their glossy heart-shaped blooms and striking tropical appeal. Sourced from premium farms, they offer long-lasting freshness, bold color, and a modern, luxurious look. Perfect for stylish arrangements, contemporary décor, and meaningful gifting.
            </p>
            ...
            <div class="mt-3 text-color details">
              ...
              <p><span class="heading-td">Category:</span> Anthurium</p>
              <p>
