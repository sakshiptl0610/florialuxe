...
<div>
  <div class="top-header body-content">
    <div class="main-container d-flex justify-content-between align-items-center">
      <h2 class="page-title font-canegroni">Card</h2>
      <div class="breadcrumb font-nexalight  ">Home /card</div>
    </div>
  </div>
      ...
      <div class="product-row">
        ...
        <div class="product-row-inner">
          <div class="p-product-image">
            <img id="mainProductImage" src="<?= base_url() ?>assets/Images/card.webp"
...
>>>>>>> 4eac9f3169ad26abe712cd4a2053d49387595a5d
            ...
            <div class="mt-3 text-color details">
              ...
              <p><span class="heading-td">Category:</span> Card</p>
              <p>
