...
<div>
  <div class="top-header body-content">
    <div class="main-container d-flex justify-content-between align-items-center">
      <h2 class="page-title font-canegroni">Roses</h2>
      <div class="breadcrumb font-nexalight  ">Home /roses</div>
    </div>
  </div>
        ...
        <div class="product-row-inner">
          ...
          <div class=" product-content-box">
            ...
            <p class="text-color font-nexalight tagline mt-3 ">
              Our roses are hand-picked from premium farms and delivered fresh every single day. Each stem is carefully selected for perfect bloom, long-lasting freshness, and rich natural fragrance. We ensure exceptional quality, making every arrangement elegant, luxurious, and made to impress.
            </p>
