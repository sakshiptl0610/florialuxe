    ...
    <div class="row g-4 justify-content-center">
      ...
      <div class="col-md-4">
        <div class="pricing-card font-nexalight">
          ...
          <h4 class="plan-title font-adelia">Weekly Delight</h4>
          <p>
            A soft rotation of fresh, romantic blooms ideal for cozy offices and welcoming reception desks.
          </p>
          <p class="tagline">A touch of beauty, every week.</p>
      ...
      <div class="col-md-4">
        <div class="pricing-card font-nexalight">
          ...
          <h4 class="plan-title font-adelia">Executive Harmony</h4>
          <p>
            Designed for premium corporate environments—balanced, lush arrangements that add warmth and sophistication to your workspace.
          </p>
          <p class="tagline">Where nature meets prestige.</p>

          <a href="#" class="pricing-btn">Subscribe</a>
        </div>
      </div>

      <!-- Luxe Bespoke Experience -->
      <div class="col-md-4">
        <div class="pricing-card font-nexalight">

          <h4 class="plan-title font-adelia">Luxe Bespoke Experience</h4>
          <p>
            Fully customized floral artistry for brands that want unforgettable, one-of-a-kind statements tailored to their identity and atmosphere.
          </p>
          <p class="tagline">Tailored luxury, delivered with love.</p>
