...
<div>
  <div class="top-header body-content">
    <div class="main-container d-flex justify-content-between align-items-center">
      <h2 class="page-title font-canegroni">Candle</h2>
      <div class="breadcrumb font-nexalight  ">Home /candle</div>
    </div>
  </div>
  ...
  <div class="main-container">
    <div class="inner-p-container">
      <div class="view-cart-box">
        <div>
          “Candle” has been added to your cart.
        </div>
      ...
      <div class="product-row">
        ...
        <div class="product-row-inner">
          <div class="p-product-image">
            <img id="mainProductImage" src="<?= base_url() ?>assets/Images/candle.webp"
          ...
          <div class=" product-content-box">
            ...
            <p class="font-canegroni text-color title">Candle</p>
            ...
            <p class="text-color font-nexalight tagline mt-3 ">
              Our premium candles are crafted with high-quality wax, clean-burning wicks, and luxurious fragrances. Designed to create a calming and elegant ambiance, they offer long-lasting scent and a smooth, even burn. Perfect for home décor, gifting, or adding a touch of luxury to any space.
            </p>
            ...
            <div class="mt-3 text-color details">
              ...
              <p><span class="heading-td">Category:</span> Candle</p>
              <p>
